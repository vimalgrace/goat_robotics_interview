...
def generate_launch_description():
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(goat_nav2_dir, 'maps', 'my_demo_map.yaml'),
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(goat_nav2_dir, 'params', 'nav2_params.yaml'),
    ...
    #     'async_param',
    #     default_value=os.path.join(goat_nav2_dir, 'config', 'mapper_params_online_async.yaml'),
    ...
    robot_localization_node = Node(
       ...
       output='screen',
       parameters=[os.path.join(goat_nav2_dir, 'config/ekf.yaml'), {'use_sim_time': use_sim_time}]
)
